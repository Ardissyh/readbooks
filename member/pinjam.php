...
<div class="card mb-auto">
    ...
    <div class="input-group mb-3 mt-3">
            ...
            <input type="date" name="tgl_pinjam" id="tgl_pinjam" class="form-control" value="<?= $sekarang; ?>" placeholder="id buku" aria-label="tgl_pinjam" aria-describedby="basic-addon1" required>
      </div>
    <div class="input-group mb-3 mt-3">
