            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-floating">
                                <textarea class="form-control" id="alamat" name="alamat" placeholder="Comment goes here"></textarea>
                    ...
                    <div class="text-center button-right">
                        ...
                        <p class="mt-2">Sudah punya akun? <a href="login.php" class="btn-link text-black">Login</a></p>
                    </div>
                </form>
            </div>
        </div>
