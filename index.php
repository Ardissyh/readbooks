        ...
        <div class="layout-card-custom mt-2">
          <?php foreach ($buku as $item) : ?>
            <div class="card" style="width: 10rem;">
              <a href="login.php"><img src="imgDB/<?= $item["cover"]; ?>" class="card-img-top" alt="coverBuku" height="200px"></a>
              <div class="card-body">
                ...
                <div class="modal-content">
                  <form method="post" enctype="multipart/form-data" action="">
                    ...
                    <div class="modal-body bg-dark">
                      <div class="row">
                        <div class="col-md-6">
                          <img src="imgDB/<?= $item["cover"]; ?>" class="img-thumbnail mb-4" alt="Mobil Image">
                        </div>
                        <div class="col-md-6">
                          <div>
